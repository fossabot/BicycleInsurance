...
namespace Raci.B2C.Bicycle.ClientApi
{
    ...
    /// </summary>
    public partial class BicyclePolicies : IServiceOperations<RaciB2CBicycleService>, IBicyclePolicies
    {
        /// <summary>
        /// Initializes a new instance of the BicyclePolicies class.
        /// </summary>
        /// <param name='client'>
        /// Reference to the service client.
        /// </param>
        public BicyclePolicies(RaciB2CBicycleService client)
        {
            if (client == null) 
            {
        ...
        /// The cancellation token.
        /// </param>
        public async Task<HttpOperationResponse<PolicyDTO>> SetDetailsWithHttpMessagesAsync(long? id, BicyclePolicyDetailDTO details, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (id == null)
            {
            ...
            if (shouldTrace)
            {
                ...
                tracingParameters.Add("details", details);
                tracingParameters.Add("cancellationToken", cancellationToken);
                ServiceClientTracing.Enter(invocationId, this, "SetDetails", tracingParameters);
            }
            // Construct URL
            var baseUrl = this.Client.BaseUri.AbsoluteUri;
            var url = new Uri(new Uri(baseUrl + (baseUrl.EndsWith("/") ? "" : "/")), "api/BicyclePolicies/{id}").ToString();
